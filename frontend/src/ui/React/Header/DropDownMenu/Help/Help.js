...
export default class Help extends React.Component {
  ...
  outputFlat2D = () => {
    ...
    if (!navigator.msSaveBlob) { // detect if not Edge
      file = new File([doc], "Flat2D.emsx");
    } else {
      file = new Blob([doc]);
      file = this.blobToFile(file, "Flat2D.emsx");
    }
    app.open(file);
  };
  ...
  outputTutorial = ()=>{
    ...
    let file;
    if (!navigator.msSaveBlob) { // detect if not Edge
      file = new File([doc], "tutorial.emsx");
    } else {
      file = new Blob([doc]);
      file = this.blobToFile(file, "tutorial.emsx");
    }
    app.open(file);
  };
  ...
  outputBend2D = () => {
    ...
    let file;
    if (!navigator.msSaveBlob) { // detect if not Edge
      file = new File([doc], "Bend2D.emsx");
    } else {
      file = new Blob([doc]);
      file = this.blobToFile(file, "Bend2D.emsx");
    }
    app.open(file);
  };
    ...
    return (
      <li className="metismenu-item" onClick={this.toggleDropdownMenu}>
        ...
        <ul className={this.state.displayMenu ? "metismenu-container visible" : "metismenu-container"}>
            <li className="metismenu-item" onClick={this.outputTutorial}><a className="metismenu-link close" href="#">Drawing tutorial</a></li>
            <li className="metismenu-item" onClick={this.openHelpLink}><a className="metismenu-link close" href="https://www.emachineshop.com/help/" target="_blank" rel="noreferrer noopener">User Guide</a></li>
            <li className="metismenu-item" onClick={this.openWindow}><a className="metismenu-link close" href="https://www.emachineshop.com/video-tutorials/" target="_blank" rel="noreferrer noopener">Video Tutorials</a></li>
            <li className="metismenu-item" onClick={() => {window.open('https://www.emachineshop.com/free-download/');}}><a className="metismenu-link close" href="#">Windows version</a></li>
            <li className="metismenu-item" onClick={this.handleOpenTechSupport.bind(this)}><a className="metismenu-link close" href="#">Tech Support</a></li>
            <li className="metismenu-item" onClick={this.handleOpenFeedback.bind(this)}><a className="metismenu-link close" href="#">Feedback</a></li>
            <li className="metismenu-item" onClick={this.handleClickOpen}><a className="metismenu-link close" href="#">About</a></li>
        </ul>
        {/* -------------------------About window-------------------------------------------- */}
        <Dialog
