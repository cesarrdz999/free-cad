...
export default class Arc extends GraphicElement{
    ...
    get incrementAngle(){
        ...
        if(this.endAngle> this.startAngle)
            res = this.endAngle - this.startAngle;
        else
            res = this.endAngle+(360-this.startAngle);

        if(Helper.Math.equals(res, 0)){
            res =360;
        }
        return res;
    }
    ...
    getMagnificationPoints(){
        if(this.incrementAngle!=360){
            return [this.center,this.getPointOffset(0.5),...this.extremePoints];
        }
        return [this.center,
    ...
    getExtrenum(){
        ...
        let xMax = [
            [maxX, maxX, maxX, maxX],
            [c.x+r, maxX, maxX, maxX],
            [c.x+r, c.x+r, maxX, maxX],
            [c.x+r, c.x+r, c.x+r, maxX]
        ];
