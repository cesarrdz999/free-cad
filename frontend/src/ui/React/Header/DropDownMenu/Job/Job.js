    ...
    return (
      <li className="metismenu-item" onClick={this.toggleDropdownMenu}>
        ...
        <ul className={this.state.displayMenu ? "metismenu-container visible" : "metismenu-container"}>
          <li className="metismenu-item" onClick={this.clickSubModal}><a className="metismenu-link close" href="#">Settings</a></li>
          <li className="metismenu-item" onClick={()=>{window.open('https://www.emachineshop.com/help-ordering/#pre-order-checklist');}}><a className="metismenu-link close" target="_blank" rel="noreferrer noopener"> Pre-Order Checklist </a></li>
          <li className="metismenu-item" onClick={()=>{window.open('https://www.emachineshop.com/order-status');}}><a className="metismenu-link close" target="_blank" rel="noreferrer noopener"> Order status </a></li>
          <li className="metismenu-item" onClick={()=>{this.props.openPriceModal(!this.props.openPrice);}}><a className="metismenu-link close" href="#">Review & Place Order...</a></li>
          <Material closeMenu={this.props.closeMenu}></Material>
          <SelectFinish closeMenu={this.props.closeMenu}></SelectFinish>
        </ul>
        <Dialog
          maxWidth="lg"
          fullWidth={true}
