  ...
  render() {
    return (
      <Fragment>
        ...
        <ToolButton className="btn-Up" onClick={this.moveUp} tabIndex={-1}>
            <img
              width="18px"
        ...
        <ToolButton className="btn-Down" onClick={this.moveDown} tabIndex={-1}>
            <img
              width="18px"
        ...
        <ToolButton className="btn-Left" onClick={this.moveLeft} tabIndex={-1}>
            <img
              width="18px"
        ...
        <ToolButton className="btn-Right" onClick={this.moveRight} tabIndex={-1}>
            <img
              width="18px"
        ...
        <ToolButton className="btn-LeftRotate" onClick={this.rotateLeft} tabIndex={-1}>
            <img
              width="18px"
        ...
        <ToolButton className="btn-RightRotate" onClick={this.rotateRight} tabIndex={-1}>
            <img
              width="18px"
