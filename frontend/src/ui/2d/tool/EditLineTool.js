...
export default class EditLineTool extends DynamicChangeTool{
    ...
    render(board){
        ...
        if(this.mouseDownPosition) {
            let elements = this.selectElementsPair.map(e => e.copy);
            new MoveBasePointsCommand(this.doc, elements, this.mouseDownPosition, this.editVector).executeCommand();
            container.resolve('propertyBar').recalculateFields(elements);
        }
