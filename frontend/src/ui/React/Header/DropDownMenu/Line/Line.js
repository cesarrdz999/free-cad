    ...
    return (
        <li className="metismenu-item" onClick={this.toggleDropdownMenu}>
            ...
            <ul className={this.state.displayMenu ? "metismenu-container visible" : "metismenu-container"}>
              <li className="metismenu-item" onClick={() => app.group()}><a className="metismenu-link close" href="#">Group</a></li>
              <li className="metismenu-item" onClick={() => app.ungroup()}><a className="metismenu-link close" href="#">Ungroup</a></li>
              <li className="metismenu-item" onClick={() => app.intersectSelectedElements()}><a className="metismenu-link close" href="#" target="_blank" rel="noreferrer noopener">Intersect</a></li>
              <li className="metismenu-item" onClick={() => app.divideSelectElement()}><a className="metismenu-link close" href="#" target="_blank" rel="noreferrer noopener">Divide</a></li>
              <li className="metismenu-item" onClick={() => app.corner()}><a className="metismenu-link close" href="#">Corner</a></li>
              <li className="metismenu-item" onClick={() => app.tangentsSelectedArcs()}><a className="metismenu-link close" href="#">Tangents</a></li>
              <li className="metismenu-item" onClick={() => app.simplify()}><a className="metismenu-link close" href="#">Simplify</a></li>
              <li className="metismenu-item" onClick={this.toggleSubMenu}>
                ...
                <ul className={this.state.displaySubMenu ? "metismenu-container visible" : "metismenu-container"}>
                  <li className="metismenu-item" onClick={() => app.mirrorSelected(Trigonometric.axisX)}><a className="metismenu-link close" href="#">Horizontally</a></li>
                  <li className="metismenu-item" onClick={() => app.mirrorSelected(Trigonometric.axisY)}><a className="metismenu-link close" href="#">Vertically</a></li>
                </ul>
              </li>
            </ul>
        </li>
