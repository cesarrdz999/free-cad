...
import shapeLibraryReducer from './reducers/shapeLibraryReducer';
import straightLineWindowReducer from './reducers/straightLineWindowReducer';
import quantityWindowReducer from './reducers/quantityWindowReducer';
...
export default combineReducers({
    ...
    shapeLibraryReducer,
    straightLineWindowReducer,
    quantityWindowReducer
})
