...
import EngraveNotInShape from '../rules/EngraveNotInShape'
import EngraveInsideHole from '../rules/EngraveInsideHole'
import NotConvertedText from "../rules/NotConvertedText";
import NotEndAtEdgesBend from "../rules/NotEndAtEdgesBend";
...
export default class ErrorModelAnalyzer extends Analyzer{
    ...
    constructor(document){
        ...
        this.rules.push(new EngraveNotInShape(document));
        this.rules.push(new EngraveInsideHole(document));
        this.rules.push(new NotEndAtEdgesBend(document));
