...
export default class TextRenderer extends Render{
    ...
    drawElement(board){
        ...
        if(this.element.font && this.element.font.isLoad &&
            (this.element.lineType.name=='Auto' || this.element.lineType.name=='Engrave')) {
            height*=1.325;
            ...
            if(this.element.lineType.name=="Auto" || this.element.lineType.name=="Engrave"){
                path.fill=null;
            }
