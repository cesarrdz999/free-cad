                ...
                <ul onClick={this.props.closeMenu} className={this.state.displayMenu ? "metismenu-container visible" : "metismenu-container"}>
                    {materialList.map((material, i) => (
                        <li value={material.name} onClick={() => this.chengeMaterial(material)} key={material.id} className={this.isCompatible(material) ? "metismenu-item" : "metismenu-item disableItem"}>
                            <a className="metismenu-link close" href="#">{material.name}</a>
                        </li>
                    ))}
                    <li className="metismenu-item" onClick={this.openWindow}>
                        <a className="metismenu-link close" href="https://www.emachineshop.com/" target="_blank" rel="noreferrer noopener">Help</a>
                    </li>
                </ul>
            </li>
        )
